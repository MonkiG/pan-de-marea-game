...
const specs = [
  ...
  {
    path: 'assets/pixel-art/v1/characters/brine-crawler.png',
    width: 640,
    height: 336,
    colors: 16,
    frame: [80, 48],
    usedPerRow: [6, 8, 4, 8, 4, 4, 6],
  },
  {
    path: 'assets/pixel-art/v1/characters/abyssal-spitter.png',
    width: 640,
    height: 384,
    colors: 16,
    frame: [80, 64],
    usedPerRow: [6, 6, 6, 8, 4, 8],
  },
  {
    path: 'assets/pixel-art/v1/characters/black-coral-sentinel.png',
    width: 768,
    height: 784,
    colors: 16,
    frame: [96, 112],
    usedPerRow: [6, 4, 8, 8, 8, 4, 8],
  },
  {
